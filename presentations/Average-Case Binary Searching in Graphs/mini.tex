...
We give \textbf{approximation} algorithms for the problem:
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $O\br{\spr{V\br{H}}^2}$-approximation for graphs excluding $H$ as a minor which yields $O\br{1}$-approximation for many important graph classes, such as planar graphs, graphs of bounded treewidth, etc.
    \end{itemize}
\end{itemize}
\end{frame}
...
\textbf{Bad news}: The Weighted $\alpha$–separator Problem is \textbf{NP–hard} even fot stars.
