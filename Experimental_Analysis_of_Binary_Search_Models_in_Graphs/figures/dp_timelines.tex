...
\begin{minipage}[t]{0.37\textwidth}
    ...
    \draw[very thick, fill=white, drop shadow] (-0.8,-1) -- (-1.1,-1.6) -- (-0.5,-1.6) -- cycle;

    \draw[very thick, fill=white, drop shadow] (0.2,-0.9) -- (0.6,-1.7) -- (-0.2,-1.7) -- cycle;


    \node at (0.85, -1.25) {$\dots$}; 

    \draw[very thick, fill=white, drop shadow] (1.5,-0.8) -- (1,-1.8) -- (2,-1.8) -- cycle;

    \draw[very thick] (1) -- (-0.8,-1);
    \draw[very thick] (1) -- (0.2,-0.9);
    \draw[very thick] (1) -- (1.5,-0.8);

    \draw[very thick, fill=white, drop shadow] (-1.2,-3.3) -- (-1.8,-4.5) -- (-0.6,-4.5) -- cycle;

    \draw[very thick, fill=white, drop shadow] (0.4,-3.2) -- (-0.3,-4.6) -- (1.1,-4.6) -- cycle;
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \draw[very thick, fill=white, drop shadow] (-0.8,-0.5) -- (-1.1,-1.1) -- (-0.5,-1.1) -- cycle;

    \draw[very thick, fill=white, drop shadow] (0.2,-0.4) -- (0.6,-1.2) -- (-0.2,-1.2) -- cycle;


    \node at (0.85, -0.75) {$\dots$}; 

    \draw[very thick, fill=white, drop shadow] (1.5,-0.3) -- (1,-1.3) -- (2,-1.3) -- cycle;

    \draw[very thick] (1) -- (-0.8,-0.5);
    \draw[very thick] (1) -- (0.2,-0.4);
    \draw[very thick] (1) -- (1.5,-0.3);

    \draw[very thick, fill=white, drop shadow] (0.4,-3.3) -- (-0,-4.1) -- (0.8,-4.1) -- cycle;

    \draw[very thick, fill=white, drop shadow] (1.6,-3.2) -- (1.1,-4.2) -- (2.1,-4.2) -- cycle;
    ...
    \draw[very thick, fill=white, drop shadow] (-1,-4.5) -- (-0.75,-5) -- (-1.25,-5) -- cycle;

    \draw[very thick] (16) -- (-1,-4.5);
