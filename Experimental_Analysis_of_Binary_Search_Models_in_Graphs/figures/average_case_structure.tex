...
\begin{minipage}
    ...
    \begin{tikzpicture}[scale=1]
        ...
        \end{tikzpicture}
\end{minipage}
    \caption[Separator $S_T$ and structure of the decision tree $D_T$]{The separator $S_T$ produced by the algorithm and the structure of the decision tree built using $S_T$.}
