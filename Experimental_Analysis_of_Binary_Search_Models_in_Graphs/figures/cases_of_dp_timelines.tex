...
\begin{minipage}[t]{0.2\textwidth}
    ...
    \end{tikzpicture}
    \caption[No children case]{}\label{no_children}
\end{minipage}
\begin{minipage}[t]{0.3\textwidth}
    ...
    \end{tikzpicture}
    \caption[One child case]{}\label{one_child}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
    ...
    \end{tikzpicture}
    \caption[Many children case]{}\label{many_children}
\end{minipage}
\caption[Basic cases of \texttt{DPTimelines} procedure]{Basic cases of the procedure. Figure \ref{no_children} shows the first case, when $v$ has no children. Figure \ref{one_child} shows the second case, when $v$ has one child. Figure \ref{many_children} show the last cases, when $v$ has multiple children.}\label{cases_dp_timelines_figure}
\end{figure}