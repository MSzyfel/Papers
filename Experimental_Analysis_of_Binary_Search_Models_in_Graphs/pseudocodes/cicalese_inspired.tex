...
\Fn{\FDecisionTree$\br{\mathcal{T},c}$}{
    \If{$n\br{\mathcal{T}}\leq k$}{
    $D\gets$\FExact$\br{\mathcal{T},c}$.
    ...
    \For{$1\leq i\leq k$ } 
        ...
        $\mathcal{F}\gets \mathcal{F}\cup \br{H-x}$.
        }
    ...
    $D\gets D_{\mathcal{Z}}\gets$\FExact$\br{\mathcal{T}_{\mathcal{Z}},c}$.

    \ForEach{$H\in \mathcal{T}-\mathcal{Z}$}
    {
        $D_H\gets$\FDecisionTree$\br{H,c}$.
