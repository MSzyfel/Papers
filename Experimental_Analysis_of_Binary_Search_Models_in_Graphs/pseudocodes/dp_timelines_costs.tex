...
\Fn{\FDPTimelinesCosts{$T_{v,i}, B$}}{
    \If{$i=0$}{
        \For{$1\leq b\leq d$ and $0\leq s\leq \br{k/pn \text{\textbf{ if} }c\br{v}>pk \text{\textbf{ else} 0}}$}{
            ...
            \If{\textnormal{$D$ is not conflicted.}}{
                \textbf{if} $\COST'_{T_{v,i}}\br{D,c',k}\leq dk$ \textbf{then}: \Return $D$, \textbf{else}: \Return $\emptyset$.
            }
        }
        \Return{$\emptyset$}.
    }
    ...
    \If{$i=1$}{
        \For{$1\leq b\leq d$ and $0\leq s\leq \br{k/pn \text{\textbf{ if} }c\br{v}>pk \text{\textbf{ else} 0}}$}{
            ...
            \If{\textnormal{$D$ is not conflicted and $\COST'_{T_{v,i}}\br{D,c',k}\leq dk$}}{
                \If{$\COST'_{T_{v,i}}\br{D,c,k}\leq dk$}
                {
    ...
    \Return{$\argmin_{D\in \mathcal{D}}\brc{\COST'_{T_{v,i}}\br{D,c, k}}$}.
    }
