\subsection{An $O\br{\sqrt{\log n}}$-approximation algorithm for $T||V,c||\COST_{max}$}
\label{sec:sqrt_log_n_approx}
We begin with the following proposition \cite{dereniowski2017ApproxSsForGeneralBSinWTs} about the existence of QPTAS for $T||V,c||\COST_{max}$:
...
The algorithm is very intricate and  is deferred to Section~\ref{qptasSection}.
