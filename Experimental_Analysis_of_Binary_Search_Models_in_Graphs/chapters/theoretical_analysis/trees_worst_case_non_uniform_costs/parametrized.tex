...
$$
\COST_{\mathcal{T}}\br{D}\leq 2\cdot\OPT\br{T}.
$$
\begin{proof}
    There are two cases:
    \begin{enumerate}
...
$$
\COST_{\mathcal{T}}\br{D}\leq\frac{\fl{\log n}+1}{\log n}\leq \frac{\log n+1}{\log n}\leq2\leq 2\cdot \OPT(\mathcal{T})\leq 2\cdot\OPT(T),
$$
...
\begin{lemma}\label{auxTreeCostLemma}
    ...
    \begin{proof}
        ...
        $$
        \COST_{\mathcal{T}_{\mathcal{Z}}}\br{D_{\mathcal{Z}}'} \leq \OPT\br{\mathcal{T}\angl{\mathcal{Z}}}.
        $$
...
\begin{lemma}\label{heavygroupcostlemma}
    ...
    $$\COST_{\mathcal{T}'\angl{H}}\br{D_H}\leq 2\cdot\OPT\br{\mathcal{T}}.$$
    \begin{proof}
        
    For every $v\in H$ let $c'\br{v}=a$. We have $2 c'\br{v}\geq b c'\br{v}/a =  b \geq c\br{v}$ so we get that $2\cdot\COST_{\mathcal{T}'\angl{H}}\br{D_H, c'}\geq \COST_{\mathcal{T}'\angl{H}}\br{D_H, c}$. Additionally, using the fact that $c'\br{v} \leq c\br{v}$ we have that $\OPT\br{\mathcal{T}'\angl{H}, c'}\leq \OPT\br{\mathcal{T}'\angl{H}, c}$. Hence:
    
    \begin{align*}
        \COST_{\mathcal{T}'\angl{H}}\br{D_H, c}&\leq 2\cdot\COST_{\mathcal{T}'\angl{H}}\br{D_H, c'}=2\cdot\OPT\br{\mathcal{T}'\angl{H}, c'} \\
        &\leq
...
$\COST_{\mathcal{T}}\br{D}\leq\br{4 d+2}\cdot\OPT\br{T}$.
    \begin{proof}
    ...
    We prove by induction that $\COST_{\mathcal{T}}\br{D}\leq \br{4d +2}\cdot \OPT\br{T}$. When $d=0$ (the base case), the induction hypothesis is true, due to the Lemma \ref{baseOfRecursion}. For $d>0$, assume by induction that the cost of the decision tree  built for each $L$, is at most $\COST_{\mathcal{T}}\br{D_L}\leq \br{4\br{d-1} +2}\cdot \OPT\br{T}$. We have:
        \begin{align*}
        \COST_{\mathcal{T}}\br{D}
        &\leq
        \COST_{\mathcal{T}}\br{D_{\mathcal{Z}}}+\max_{\mathcal{T}'\in \mathcal{T}-\mathcal{Z}}\brc{\COST_{\mathcal{T}'\angl{H}}\br{D_H}+\max_{L\in \mathcal{T}'-H}\brc{\COST_{L}\br{D_L}}}
         \\ 
        &\leq
        \COST_{\mathcal{T}_{\mathcal{Z}}}\br{D_{\mathcal{Z}}}+\max_{\mathcal{T}'\in \mathcal{T}-\mathcal{Z}}\brc{2\cdot\OPT\br{\mathcal{T}}+\br{4\br{d-1} +2}\cdot \OPT\br{T}}
        \\ 
        &\leq 
...
\label{parametrizedAlgorithm}
    ...
    \begin{proof}
        ...
        $$
        \COST_{\mathcal{T}}\br{D} \leq (4 \cdot \log\log n + 6) \cdot \OPT\br{T} = O\br{\log\log n \cdot \OPT\br{T}}.
        $$
