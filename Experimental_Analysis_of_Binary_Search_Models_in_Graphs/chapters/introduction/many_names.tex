...
Throughout recent years the Graph Search Problem has been continuously rediscovered under various names and definitions. 
...
\begin{itemize}
    ...
    \item Bayesian Active Learning \cite{NearoptimalBayesianactivelearning,Analysisofgreedyactivelearningstrategy,BayesianLearnerOptimalNoisyBinarySearch},
