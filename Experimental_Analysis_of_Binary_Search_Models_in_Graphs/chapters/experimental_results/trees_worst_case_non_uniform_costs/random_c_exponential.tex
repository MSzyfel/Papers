...
\end{figure}
\FloatBarrier
We observe that this time the $O\br{\log log n}$-approximation algorithm encountered instances for which it produced decision tree with approximation ratio above $2.5$. Therefore we conclude that its performances was the worst among the three algorithms. The other two algorithms achieved similar results.
