...
\FloatBarrier
We see that the running time of the exact procedure plotted on the logarithmic scale behaves as a linear function. This matches our expectation since it means that the running time is exponential in $n$. Notably, this running time is lower then the worst case running time of $2^nn$.
