\subsection{Random Trees with Uniform Cost Distribution ($T_R || V, c \sim \mathcal{U} || \COST_{max}$)}
...
\begin{itemize}
    ...
    \item The approximation ratios achieved by all approximation algorithms are significantly better than their theoretical worst-case guarantees. All of the approximation ratios were below 2. We also see that no algorithm consistently outperformed the others.
