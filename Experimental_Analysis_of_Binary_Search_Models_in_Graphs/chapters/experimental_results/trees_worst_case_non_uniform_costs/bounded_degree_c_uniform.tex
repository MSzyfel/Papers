...
\end{figure}
\FloatBarrier
We notice that the running time of the exact procedure almost strictly follows a linear function on the logarithmic plot. This will also be the case for the other cost distrubtions for bounded degree instances.
