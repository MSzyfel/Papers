...
We observe that:
\begin{itemize}
\item The running time of the exact procedure almost strictly follows a linear function on the logarithmic plot. This will also be the case for the other cost distributions for bounded degree instances.
