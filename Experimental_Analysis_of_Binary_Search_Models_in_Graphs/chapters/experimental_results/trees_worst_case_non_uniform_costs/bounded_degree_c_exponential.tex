...
\end{figure}
\FloatBarrier
This time, the $O\br{\sqrt\br{\log n}}$-approximation algorithm exhibits the best approximation factors never exceeding the value of 2 as opposed to the two other algorithms.
